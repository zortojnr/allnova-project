...
export default function Header() {
  return (
    <header className="px-4 md:px-10 lg:px-16 xl:px-[120px] 2xl:px-[200px] py-4 md:py-6">
      <div className="flex items-center justify-between gap-4">
        {/* Logo */}
        <img 
          src="/images/allnova-logo.png" 
          alt="AllNova" 
          className="h-[42px] w-[145px] object-contain bg-transparent"
          style={{ mixBlendMode: 'screen' }}
        />
        
        {/* Navigation */}
        <nav className="hidden lg:flex items-center gap-4 rounded-[100px] bg-[rgba(243,244,246,0.10)] px-[32px] py-[10px]">
